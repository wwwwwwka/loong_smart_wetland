...
void esp8266_init(void)
{
    ...
    // =0：单路连接模式；=1：多路连接模式
    printf("AT+MQTTUSERCFG=1,NULL,1c102f&k1dl3eJ2RBB,c6c25768a2245536a925a615d1e8882124b43adce8bc256832f182cfed6b3bdd,0,0,\"\"\r\n");
    while(esp8266_send_cmd(&Circular_queue_send,"AT+MQTTUSERCFG=0,1,\"NULL\",\"""1c102f&k1dl3eJ2RBB""\",\"""c6c25768a2245536a925a615d1e8882124b43adce8bc256832f182cfed6b3bdd""\",0,0,\"\"","OK",150));
    delay_ms(100);

    printf("AT+MQTTCLIENTID=0,k1dl3eJ2RBB.1c102f|securemode=2,signmethod=hmacsha256,timestamp=1719469922491|\r\n");
    esp8266_send_cmd(&Circular_queue_send,"AT+MQTTCLIENTID=0,\"k1dl3eJ2RBB.1c102f|securemode=2\\,signmethod=hmacsha256\\,timestamp=1719469922491|\"","OK",300);
    delay_ms(100);
    ...
    esp8266_send_cmd(&Circular_queue_send,"AT+MQTTSUB=0,\"/k1dl3eJ2RBB/1c102f/user/get\",1","OK",300);
    delay_ms(100);
