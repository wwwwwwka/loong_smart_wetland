...
void esp8266_init(void)
{
    ...
    while(esp8266_send_cmd(&Circular_queue_send,"AT+MQTTUSERCFG=0,1,\"NULL\",\"""1c102t&k1dl3eJ2RBB""\",\"""366f20a8da27859f2a06439fccfea00c030a6751b642968ea0345fa62c7455cb""\",0,0,\"\"","OK",150));
    delay_ms(100);

    printf("AT+MQTTCLIENTID=0,k1dl3eJ2RBB.1c102s|securemode=2,signmethod=hmacsha256,timestamp=1719636740199|\r\n");
    esp8266_send_cmd(&Circular_queue_send,"AT+MQTTCLIENTID=0,\"k1dl3eJ2RBB.1c102t|securemode=2\\,signmethod=hmacsha256\\,timestamp=1719637340162|\"","OK",300);
    delay_ms(100);
